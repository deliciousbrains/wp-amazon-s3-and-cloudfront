...
class GuzzlePearPharPackageTask extends \Task
{
    ...
    public function createSubPackages()
    {
        ...
        foreach ($this->subpackages as $package) {
            ...
            $package_info = \json_decode($composer_file, \true);
