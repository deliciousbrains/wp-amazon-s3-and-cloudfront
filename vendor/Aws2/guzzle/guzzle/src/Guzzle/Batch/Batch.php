...
use DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Batch\Exception\BatchTransferException;
/**
 ...
 */
class Batch implements \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Batch\BatchInterface
{
     ...
     */
    public function __construct(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Batch\BatchTransferInterface $transferStrategy, \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Batch\BatchDivisorInterface $divisionStrategy)
    {
        ...
        foreach ($this->dividedBatches as $batchIndex => $dividedBatch) {
            while ($dividedBatch->valid()) {
                ...
                try {
                    ...
                    throw new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Batch\Exception\BatchTransferException($batch, $items, $e, $this->transferStrategy, $this->divisionStrategy);
                }
            }
