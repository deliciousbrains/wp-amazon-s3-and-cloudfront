 ...
 */
class BatchRequestTransfer implements \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Batch\BatchTransferInterface, \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Batch\BatchDivisorInterface
{
    ...
    public function createBatches(\SplQueue $queue)
    {
        ...
        foreach ($queue as $item) {
            if (!$item instanceof RequestInterface) {
                throw new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Exception\InvalidArgumentException('All items must implement Guzzle\\Http\\Message\\RequestInterface');
            }
