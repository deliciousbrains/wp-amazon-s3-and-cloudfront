 ...
 */
class AbstractEntityBodyDecorator implements \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\EntityBodyInterface
{
    ...
    {
        $hash = \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Stream\Stream::getHash($this, 'md5', $rawOutput);
