...
interface ClientInterface extends HasDispatcherInterface
{
     ...
     */
    public function createRequest($method = \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface::GET, $uri = null, $headers = null, $body = null, array $options = array());
    /**
