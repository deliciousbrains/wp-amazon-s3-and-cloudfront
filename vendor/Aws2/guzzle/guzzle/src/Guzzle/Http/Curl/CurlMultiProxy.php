 ...
 */
class CurlMultiProxy extends \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\AbstractHasDispatcher implements \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Curl\CurlMultiInterface
{
    ...
    public function __construct($maxHandles = 3, $selectTimeout = 1.0)
    {
        ...
        class_exists('DeliciousBrains\\WP_Offload_S3\\Aws2\\Guzzle\\Http\\Message\\Response');
        class_exists('DeliciousBrains\\WP_Offload_S3\\Aws2\\Guzzle\\Http\\Exception\\CurlException');
    }
    ...
    protected function getAvailableHandle()
    {
        ...
        $handle = new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Curl\CurlMulti($this->selectTimeout);
