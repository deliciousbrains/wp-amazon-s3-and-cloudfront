...
class RequestMediator
{
     ...
     */
    public function __construct(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request, $emitIo = false)
    {
    ...
    public function receiveResponseHeader($curl, $header)
    {
        ...
        if (strpos($header, 'HTTP/') === 0) {
            ...
            $response = new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\Response($code, null, $body);
