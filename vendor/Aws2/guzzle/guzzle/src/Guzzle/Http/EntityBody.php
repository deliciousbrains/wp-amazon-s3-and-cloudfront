 ...
 */
class EntityBody extends \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Stream\Stream implements \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\EntityBodyInterface
{
    ...
    public static function factory($resource = '', $size = null)
    {
        ...
        throw new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Exception\InvalidArgumentException('Invalid resource type');
    }
    public function setRewindFunction($callable)
    {
        if (!is_callable($callable)) {
            throw new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Exception\InvalidArgumentException('Must specify a callable');
        }
    ...
    {
        return $this->getUri() ? \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Mimetypes::getInstance()->fromFilename($this->getUri()) : null;
    }
     ...
     * @codeCoverageIgnore
     */
    public static function calculateMd5(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\EntityBodyInterface $body, $rawOutput = false, $base64Encode = false)
    {
        \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Version::warn(__CLASS__ . ' is deprecated. Use getContentMd5()');
