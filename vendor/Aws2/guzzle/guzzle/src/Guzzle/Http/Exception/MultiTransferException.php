 ...
 */
class MultiTransferException extends \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Exception\ExceptionCollection
{
     ...
     * @return self
     */
    public function addSuccessfulRequest(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     * @return self
     */
    public function addFailedRequest(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     * @return self
     */
    public function addFailedRequestWithException(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request, \Exception $exception)
    {
     ...
     */
    public function getExceptionForFailedRequest(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     * @return bool
     */
    public function containsRequest(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
