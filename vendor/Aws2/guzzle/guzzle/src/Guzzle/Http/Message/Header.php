 ...
 */
class Header implements \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\Header\HeaderInterface
{
    ...
    public function raw()
    {
        \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Version::warn(__METHOD__ . ' is deprecated. Use toArray()');
        return $this->toArray();
    }
    /**
