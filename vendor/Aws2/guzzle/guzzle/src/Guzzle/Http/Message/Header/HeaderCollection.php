 ...
 */
class HeaderCollection implements \IteratorAggregate, \Countable, \ArrayAccess, \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\ToArrayInterface
{
    /** @var array */
    protected $headers;
     ...
     * @return self
     */
    public function add(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\Header\HeaderInterface $header)
    {
