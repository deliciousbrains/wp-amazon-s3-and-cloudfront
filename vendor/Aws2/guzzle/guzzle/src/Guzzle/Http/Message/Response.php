 ...
 */
class Response extends \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\AbstractMessage implements \Serializable
{
    /**
    ...
    public function xml()
    {
        ...
        if ($errorMessage) {
            throw new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Exception\RuntimeException('Unable to parse response body into XML: ' . $errorMessage);
        }
        return $xml;
    }
    /**
    ...
    {
        return (int) $this->params->get(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\RedirectPlugin::REDIRECT_COUNT);
    }
    /**
    ...
    {
        \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Version::warn(__METHOD__ . ' is deprecated. Use the HistoryPlugin.');
        return null;
    }
    /**
     * @deprecated
