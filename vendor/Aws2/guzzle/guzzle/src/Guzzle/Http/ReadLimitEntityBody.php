...
use DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Stream\StreamInterface;
/**
 * EntityBody decorator used to return only a subset of an entity body
 */
class ReadLimitEntityBody extends \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\AbstractEntityBodyDecorator
{
     ...
     */
    public function __construct(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\EntityBodyInterface $body, $limit, $offset = 0)
    {
