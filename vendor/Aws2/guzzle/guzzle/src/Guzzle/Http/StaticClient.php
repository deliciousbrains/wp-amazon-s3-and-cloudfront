...
use DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Client;
use DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\ClientInterface;
use DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Stream\StreamRequestFactoryInterface;
...
final class StaticClient
{
     ...
     */
    public static function mount($className = 'Guzzle', \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\ClientInterface $client = null)
    {
    ...
    public static function request($method, $url, $options = array())
    {
        ...
        if (!self::$client) {
            self::$client = new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Client();
        }
        ...
        if (isset($options['stream'])) {
            if ($options['stream'] instanceof StreamRequestFactoryInterface) {
                ...
                $streamFactory = new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Stream\PhpStreamRequestFactory();
