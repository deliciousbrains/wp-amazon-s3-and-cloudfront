...
class MessageFormatter
{
     ...
     * @return string
     */
    public function format(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request, \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\Response $response = null, \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Curl\CurlHandle $handle = null, array $customData = array())
    {
        $cache = $customData;
