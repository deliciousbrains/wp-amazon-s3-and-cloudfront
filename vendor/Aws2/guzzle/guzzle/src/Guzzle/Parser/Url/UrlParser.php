...
namespace DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Parser\Url;
 ...
 * @codeCoverageIgnore
 */
class UrlParser implements \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Parser\Url\UrlParserInterface
{
    ...
    {
        \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Version::warn(__CLASS__ . ' is deprecated. Just use parse_url()');
