 ...
 */
class BackoffLogger implements \DeliciousBrains\WP_Offload_S3\Aws2\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
     ...
     */
    public function __construct(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Log\LogAdapterInterface $logger, \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Log\MessageFormatter $formatter = null)
    {
        $this->logger = $logger;
        $this->formatter = $formatter ?: new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Log\MessageFormatter(self::DEFAULT_FORMAT);
    }
    public static function getSubscribedEvents()
    {
        return array(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Plugin\Backoff\BackoffPlugin::RETRY_EVENT => 'onRequestRetry');
    }
    /**
     ...
     */
    public function onRequestRetry(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Event $event)
    {
