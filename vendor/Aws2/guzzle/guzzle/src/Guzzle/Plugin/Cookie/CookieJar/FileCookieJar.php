 ...
 */
class FileCookieJar extends \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Plugin\Cookie\CookieJar\ArrayCookieJar
{
    /** @var string filename */
    protected $filename;
    /**
    ...
    protected function persist()
    {
        if (false === file_put_contents($this->filename, $this->serialize())) {
            ...
            throw new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Exception\RuntimeException('Unable to open file ' . $this->filename);
