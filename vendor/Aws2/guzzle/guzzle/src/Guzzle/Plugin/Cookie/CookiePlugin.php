...
namespace DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Plugin\Cookie;

use DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Event;
use DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Plugin\Cookie\CookieJar\ArrayCookieJar;
use DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Plugin\Cookie\CookieJar\CookieJarInterface;
use DeliciousBrains\WP_Offload_S3\Aws2\Symfony\Component\EventDispatcher\EventSubscriberInterface;
/**
 * Adds, extracts, and persists cookies between HTTP requests
 */
class CookiePlugin implements \DeliciousBrains\WP_Offload_S3\Aws2\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
     ...
     */
    public function __construct(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Plugin\Cookie\CookieJar\CookieJarInterface $cookieJar = null)
    {
        $this->cookieJar = $cookieJar ?: new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Plugin\Cookie\CookieJar\ArrayCookieJar();
    }
