 ...
 */
class CommandContentMd5Plugin implements \DeliciousBrains\WP_Offload_S3\Aws2\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    ...
    public function onCommandBeforeSend(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Event $event)
    {
        ...
        if ($command[$this->validateMd5Param] === true) {
            $request->addSubscriber(new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Plugin\Md5\Md5ValidatorPlugin(true, false));
        }
    }
}
