...
namespace DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Plugin\Oauth;
 ...
 */
class OauthPlugin implements \DeliciousBrains\WP_Offload_S3\Aws2\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
    ...
    {
        $this->config = \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Collection::fromConfig($config, array('version' => '1.0', 'request_method' => self::REQUEST_METHOD_HEADER, 'consumer_key' => 'anonymous', 'consumer_secret' => 'anonymous', 'signature_method' => 'HMAC-SHA1', 'signature_callback' => function ($stringToSign, $key) {
     ...
     * @return string
     */
    public function getSignature(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request, $timestamp, $nonce)
    {
     ...
     * @return string
     */
    public function getStringToSign(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request, $timestamp, $nonce)
    {
        ...
        $url = \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Url::factory($request->getUrl())->setQuery('')->setFragment(null);
    ...
    {
        $params = new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Collection(array('oauth_consumer_key' => $this->config['consumer_key'], 'oauth_nonce' => $nonce, 'oauth_signature_method' => $this->config['signature_method'], 'oauth_timestamp' => $timestamp));
     ...
     * @return array
     */
    public function getParamsToSign(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request, $timestamp, $nonce)
    {
     ...
     * @return string
     */
    public function generateNonce(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     * @return int
     */
    public function getTimestamp(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Event $event)
    {
