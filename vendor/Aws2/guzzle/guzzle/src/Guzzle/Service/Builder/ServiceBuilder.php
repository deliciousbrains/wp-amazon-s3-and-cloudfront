...
namespace DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Builder;
...
use DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Exception\ServiceBuilderException;
use DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Exception\ServiceNotFoundException;
 ...
 */
class ServiceBuilder extends \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\AbstractHasDispatcher implements \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Builder\ServiceBuilderInterface, \ArrayAccess, \Serializable
{
    ...
    public static function factory($config = null, array $globalParameters = array())
    {
        ...
        if (!static::$cachedFactory) {
            static::$cachedFactory = new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Builder\ServiceBuilderLoader();
        }
     ...
     * @return self
     */
    public function addGlobalPlugin(\DeliciousBrains\WP_Offload_S3\Aws2\Symfony\Component\EventDispatcher\EventSubscriberInterface $plugin)
    {
        $this->plugins[] = $plugin;
        return $this;
    }
    ...
    public function get($name, $throwAway = false)
    {
        if (!isset($this->builderConfig[$name])) {
            ...
            throw new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Exception\ServiceNotFoundException('No service is registered as ' . $name);
        }
