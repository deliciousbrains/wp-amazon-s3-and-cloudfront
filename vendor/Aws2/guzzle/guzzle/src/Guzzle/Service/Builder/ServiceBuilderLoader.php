 ...
 */
class ServiceBuilderLoader extends \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\AbstractConfigLoader
{
        ...
        foreach ($services as $name => &$service) {
            ...
            if (!empty($service['extends'])) {
                ...
                if (!isset($services[$service['extends']])) {
                    throw new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Exception\ServiceNotFoundException("{$name} is trying to extend a non-existent service: {$service['extends']}");
                }
