 ...
 */
class AliasFactory implements \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Command\Factory\FactoryInterface
{
     ...
     */
    public function __construct(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\ClientInterface $client, array $aliases)
    {
        $this->client = $client;
