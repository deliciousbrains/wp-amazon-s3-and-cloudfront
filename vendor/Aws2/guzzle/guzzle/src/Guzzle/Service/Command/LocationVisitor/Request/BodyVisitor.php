 ...
 */
class BodyVisitor extends \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Command\LocationVisitor\Request\AbstractRequestVisitor
{
    public function visit(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Command\CommandInterface $command, \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request, \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\Parameter $param, $value)
    {
        ...
        $entityBody = \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\EntityBody::factory($value);
     ...
     */
    protected function addExpectHeader(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\EntityEnclosingRequestInterface $request, \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\EntityBodyInterface $body, $expect)
    {
