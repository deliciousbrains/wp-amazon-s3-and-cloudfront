 ...
 */
class XmlVisitor extends \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Command\LocationVisitor\Request\AbstractRequestVisitor
{
     ...
     * @return \XMLWriter
     */
    protected function createRootElement(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\Operation $operation)
    {
     ...
     */
    protected function addXml(\XMLWriter $xmlWriter, \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\Parameter $param, $value)
    {
        if ($value === null) {
            return;
        }
     ...
     */
    protected function addXmlArray(\XMLWriter $xmlWriter, \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\Parameter $param, &$value)
    {
     ...
     */
    protected function addXmlObject(\XMLWriter $xmlWriter, \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\Parameter $param, &$value)
    {
        $noAttributes = array();
