 ...
 */
class SchemaValidator implements \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\ValidatorInterface
{
    ...
    public function validate(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\Parameter $param, &$value)
    {
        $this->errors = array();
     ...
     */
    protected function recursiveProcess(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\Parameter $param, &$value, $path = '', $depth = 0)
    {
