 ...
 */
class ServiceDescription implements \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\ServiceDescriptionInterface, \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\ToArrayInterface
{
    ...
    public static function factory($config, array $options = array())
    {
        ...
        if (!self::$descriptionLoader) {
            self::$descriptionLoader = new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\ServiceDescriptionLoader();
        }
    ...
    public function getOperation($name)
    {
        ...
        if (!$this->operations[$name] instanceof Operation) {
            $this->operations[$name] = new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\Operation($this->operations[$name], $this);
        }
     ...
     * @return self
     */
    public function addOperation(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\OperationInterface $operation)
    {
    ...
    public function getModel($id)
    {
        ...
        if (!$this->models[$id] instanceof Parameter) {
            $this->models[$id] = new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\Parameter($this->models[$id] + array('name' => $id), $this);
        }
     ...
     * @return self
     */
    public function addModel(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\Parameter $model)
    {
        ...
        if (isset($config['operations'])) {
            foreach ($config['operations'] as $name => $operation) {
                if (!$operation instanceof Operation && !is_array($operation)) {
                    throw new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Exception\InvalidArgumentException('Invalid operation in service description: ' . gettype($operation));
                }
