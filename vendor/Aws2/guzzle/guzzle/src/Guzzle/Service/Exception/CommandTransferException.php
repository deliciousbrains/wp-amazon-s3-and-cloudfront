 ...
 */
class CommandTransferException extends \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Exception\MultiTransferException
{
     ...
     * @return self
     */
    public static function fromMultiTransferException(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Exception\MultiTransferException $e)
    {
     ...
     * @return self
     */
    public function addSuccessfulCommand(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Command\CommandInterface $command)
    {
     ...
     * @return self
     */
    public function addFailedCommand(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Command\CommandInterface $command)
    {
     ...
     */
    public function getExceptionForFailedCommand(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Command\CommandInterface $command)
    {
