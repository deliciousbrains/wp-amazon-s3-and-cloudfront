 ...
 */
class Model extends \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Collection
{
     ...
     */
    public function __construct(array $data = array(), \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\Parameter $structure = null)
    {
        $this->data = $data;
    ...
    {
        return $this->structure ?: new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Service\Description\Parameter();
    }
    /**
