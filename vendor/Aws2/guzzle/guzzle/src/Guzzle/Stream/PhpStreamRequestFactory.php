...
namespace DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Stream;
 ...
 */
class PhpStreamRequestFactory implements \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Stream\StreamRequestFactoryInterface
{
     ...
     */
    public function fromRequest(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request, $context = array(), array $params = array())
    {
        if (is_resource($context)) {
            ...
            throw new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Exception\InvalidArgumentException('$context must be an array or resource');
        }
     ...
     */
    protected function addDefaultContextOptions(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     */
    protected function setUrl(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     * @param RequestInterface $request Request
     */
    protected function addSslOptions(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     */
    protected function addBodyOptions(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     * @param RequestInterface $request Request
     */
    protected function addProxyOptions(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Http\Message\RequestInterface $request)
    {
     ...
     */
    protected function processResponseHeaders(\DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Stream\StreamInterface $stream)
    {
    ...
    protected function createResource($callback)
    {
        ...
        if (!$resource) {
            ...
            throw new \DeliciousBrains\WP_Offload_S3\Aws2\Guzzle\Common\Exception\RuntimeException(trim($message));
        }
        return $resource;
    }
}
