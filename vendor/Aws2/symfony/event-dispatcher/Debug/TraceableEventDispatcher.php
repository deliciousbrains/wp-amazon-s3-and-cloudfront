...
use DeliciousBrains\WP_Offload_S3\Aws2\Symfony\Component\EventDispatcher\Event;
use DeliciousBrains\WP_Offload_S3\Aws2\Symfony\Component\Stopwatch\Stopwatch;
 ...
 */
class TraceableEventDispatcher implements \DeliciousBrains\WP_Offload_S3\Aws2\Symfony\Component\EventDispatcher\Debug\TraceableEventDispatcherInterface
{
    protected $logger;
    protected $stopwatch;
    private $called;
    ...
    public function __construct(\DeliciousBrains\WP_Offload_S3\Aws2\Symfony\Component\EventDispatcher\EventDispatcherInterface $dispatcher, \DeliciousBrains\WP_Offload_S3\Aws2\Symfony\Component\Stopwatch\Stopwatch $stopwatch, \DeliciousBrains\WP_Offload_S3\Aws2\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if (null === $event) {
            $event = new \DeliciousBrains\WP_Offload_S3\Aws2\Symfony\Component\EventDispatcher\Event();
        }
     ...
     */
    protected function preDispatch($eventName, \DeliciousBrains\WP_Offload_S3\Aws2\Symfony\Component\EventDispatcher\Event $event)
    {
    }
    /**
     ...
     * @param Event  $event     The event
     */
    protected function postDispatch($eventName, \DeliciousBrains\WP_Offload_S3\Aws2\Symfony\Component\EventDispatcher\Event $event)
    {
    }
    private function preProcess($eventName)
    {
        foreach ($this->dispatcher->getListeners($eventName) as $listener) {
            ...
            $wrappedListener = new \DeliciousBrains\WP_Offload_S3\Aws2\Symfony\Component\EventDispatcher\Debug\WrappedListener($listener, $name, $this->stopwatch, $this);
