...
abstract class AbstractRpcV2ErrorParser extends AbstractErrorParser
{
     ...
     * @return array
     */
    protected abstract function payload(ResponseInterface $response, StructureShape $member) : array;
    /**
     ...
     * @return mixed
     */
    protected abstract function parseBody(StreamInterface $body, ResponseInterface $response) : mixed;
    /**
     * @param ResponseInterface $response
     *
     * @return array
