...
abstract class AbstractRpcV2Serializer
{
     ...
     * @return string
     */
    public abstract function serialize(StructureShape $inputShape, array $commandArgs) : string;
    /**
     ...
     * @return array
     */
    protected abstract function resolveBlob(mixed $value) : array;
    /**
     ...
     * @return array
     */
    protected abstract function resolveTimestamp(int|float|string|DateTimeInterface $value) : array;
    /**
