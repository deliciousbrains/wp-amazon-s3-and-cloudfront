...
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\Auth\AuthResolver;
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\Auth\AuthSchemeResolver;
...
class ClientResolver
{
    ...
    public static function _apply_user_agent($inputUserAgent, array &$args, HandlerList $list)
    {
        ...
        if (isset($args['endpoint_discovery'])) {
            if ($args['endpoint_discovery'] instanceof \DeliciousBrains\WP_Offload_Media\Aws3\Aws\EndpointDiscovery\Configuration && $args['endpoint_discovery']->isEnabled()) {
        ...
        if (isset($args['retries'])) {
            if ($args['retries'] instanceof \DeliciousBrains\WP_Offload_Media\Aws3\Aws\Retry\Configuration) {
    ...
    public static function _default_endpoint(array &$args)
    {
        ...
        $serviceIdentifier = \DeliciousBrains\WP_Offload_Media\Aws3\Aws\manifest($args['service'])['serviceIdentifier'];
