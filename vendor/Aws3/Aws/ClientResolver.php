...
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\Token\BedrockTokenProvider;
...
class ClientResolver
{
    ...
    public static function _apply_suppress_php_deprecation_warning($value, &$args)
    {
        if ($value) {
            ...
            $args['suppress_php_deprecation_warning'] = \DeliciousBrains\WP_Offload_Media\Aws3\Aws\boolean_value(\getenv("AWS_SUPPRESS_PHP_DEPRECATION_WARNING"));
