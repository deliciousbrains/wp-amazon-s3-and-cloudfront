...
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\CloudTrail\Exception\CloudTrailException;

/**
 * The `DeliciousBrains\WP_Offload_Media\Aws3\Aws\CloudTrail\LogFileIterator` provides an easy way to iterate over
