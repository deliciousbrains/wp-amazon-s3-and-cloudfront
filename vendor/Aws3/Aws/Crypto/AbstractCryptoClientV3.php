...
abstract class AbstractCryptoClientV3
{
     ...
     * @internal
     */
    public abstract function encrypt(Stream $plaintext, AlgorithmSuite $algorithmSuite, array $options, MaterialsProviderV3 $provider, MetadataEnvelope $envelope) : AppendStream;
    /**
     ...
     * @internal
     */
    public abstract function decrypt(string $cipherText, MaterialsProviderInterfaceV3 $provider, MetadataEnvelope $envelope, string $commitmentPolicy, array $options = []) : AesStreamInterface;
}
