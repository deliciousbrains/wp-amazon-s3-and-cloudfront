 ...
 */
class AesEncryptingStream implements \DeliciousBrains\WP_Offload_S3\Aws3\Aws\Crypto\AesStreamInterface
{
    const BLOCK_SIZE = 16;
    // 128 bits
     ...
     */
    public function __construct(\DeliciousBrains\WP_Offload_S3\Aws3\Psr\Http\Message\StreamInterface $plainText, $key, \DeliciousBrains\WP_Offload_S3\Aws3\Aws\Crypto\Cipher\CipherMethod $cipherMethod)
    {
