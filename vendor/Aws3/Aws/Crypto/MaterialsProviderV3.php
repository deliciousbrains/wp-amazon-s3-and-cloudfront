...
abstract class MaterialsProviderV3 implements MaterialsProviderInterfaceV3
{
     ...
     * @return string
     */
    public abstract function getWrapAlgorithmName() : string;
    /**
     ...
     * @return string
     */
    public abstract function decryptCek(string $encryptedCek, array $materialDescription, array $options) : string;
    /**
     ...
     * @return array
     */
    public abstract function generateCek(string $keySize, array $context, array $options) : array;
    /**
