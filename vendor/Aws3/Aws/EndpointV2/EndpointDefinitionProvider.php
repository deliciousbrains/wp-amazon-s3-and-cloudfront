...
class EndpointDefinitionProvider
{
     ...
     */
    public static function getParsedRuleset($service, $apiVersion, array $partitions, $baseDir = null) : BddRuleset|Ruleset
    {
        $bdd = self::getEndpointBdd($service, $apiVersion, $baseDir, \false);
        if ($bdd !== null) {
            return new BddRuleset($bdd, $partitions);
        }
        return new Ruleset(self::getEndpointRuleset($service, $apiVersion, $baseDir), $partitions);
    }
     ...
     */
    public static function getEndpointBdd($service, $apiVersion, $baseDir = null, $throwIfMissing = \true)
    {
    ...
    private static function getData($service, $apiVersion, $type, $baseDir, $throwIfMissing = \true)
    {
