<?php
namespace DeliciousBrains\WP_Offload_Media\Aws3\Aws\KinesisAnalyticsV2;
 ...
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\Aws\Result addApplicationVpcConfiguration(array $args = [])
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Promise addApplicationVpcConfigurationAsync(array $args = [])
 ...
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\Aws\Result createApplicationSnapshot(array $args = [])
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Promise createApplicationSnapshotAsync(array $args = [])
 ...
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\Aws\Result deleteApplicationSnapshot(array $args = [])
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Promise deleteApplicationSnapshotAsync(array $args = [])
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\Aws\Result deleteApplicationVpcConfiguration(array $args = [])
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Promise deleteApplicationVpcConfigurationAsync(array $args = [])
 ...
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\Aws\Result describeApplicationSnapshot(array $args = [])
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Promise describeApplicationSnapshotAsync(array $args = [])
 ...
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\Aws\Result listApplicationSnapshots(array $args = [])
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Promise listApplicationSnapshotsAsync(array $args = [])
