...
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\Credentials\CredentialSources;
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\Token;
...
final class MetricsBuilder
{
    ...
    private function appendRetryConfigMetric(array $args) : void
    {
        ...
        $retryMode = '';
        if ($retries instanceof \DeliciousBrains\WP_Offload_Media\Aws3\Aws\Retry\Configuration) {
