...
final class Middleware
{
     ...
     *
     * @param callable $f Map function that accepts an DeliciousBrains\WP_Offload_Media\Aws3\Aws\ResultInterface and
     *                    returns an DeliciousBrains\WP_Offload_Media\Aws3\Aws\ResultInterface.
     *
     * @return callable
     */
