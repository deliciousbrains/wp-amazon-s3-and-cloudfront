...
class PresignUrlMiddleware
{
    ...
    public function __construct(array $options, callable $endpointProvider, \DeliciousBrains\WP_Offload_S3\Aws3\Aws\AwsClientInterface $client, callable $nextHandler)
    {
