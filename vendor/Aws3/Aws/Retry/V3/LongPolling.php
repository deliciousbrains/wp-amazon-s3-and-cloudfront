...
{
    private const OPERATIONS = ['sqs' => ['ReceiveMessage' => \true], 'states' => ['GetActivityTask' => \true], 'swf' => ['PollForActivityTask' => \true, 'PollForDecisionTask' => \true]];
    public static function isLongPolling(?string $service, string $operation) : bool
    {
        return $service !== null && isset(self::OPERATIONS[$service][$operation]);
    }
}
