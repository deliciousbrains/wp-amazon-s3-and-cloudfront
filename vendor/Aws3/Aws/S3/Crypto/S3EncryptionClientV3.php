...
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\Crypto\DecryptionTraitV3;
...
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\Crypto\AbstractCryptoClientV3;
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\Crypto\EncryptionTraitV3;
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\Crypto\MetadataEnvelope;
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\Crypto\AlgorithmSuite;
...
class S3EncryptionClientV3 extends AbstractCryptoClientV3
{
    ...
    public function putObjectAsync(array $args) : PromiseInterface
    {
        ...
        return Promise\Create::promiseFor(
            ...
            $this->encrypt($bodyStream, $algorithmSuite, $options, $provider, $envelope)
