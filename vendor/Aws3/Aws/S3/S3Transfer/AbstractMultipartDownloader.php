...
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\S3\S3Transfer\Models\DownloadResult;
...
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\S3\S3Transfer\Utils\ResumableDownloadHandlerInterface;
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\S3\S3Transfer\Utils\AbstractDownloadHandler;
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\S3\S3Transfer\Utils\StreamDownloadHandler;
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Coroutine;
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Create;
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Each;
...
abstract class AbstractMultipartDownloader implements PromisorInterface
{
     ...
     * @return array
     */
    protected abstract function getFetchCommandArgs() : array;
    /**
     ...
     * @return void
     */
    protected abstract function computeObjectDimensions(ResultInterface $result) : void;
