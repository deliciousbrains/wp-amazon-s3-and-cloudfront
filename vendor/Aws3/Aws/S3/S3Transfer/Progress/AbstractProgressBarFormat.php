...
abstract class AbstractProgressBarFormat
{
     ...
     * @return string
     */
    public abstract function getFormatTemplate() : string;
    /**
     * @return array
     */
    public abstract function getFormatParameters() : array;
    /**
     * @return array
     */
    protected abstract function getFormatDefaultParameterValues() : array;
}
