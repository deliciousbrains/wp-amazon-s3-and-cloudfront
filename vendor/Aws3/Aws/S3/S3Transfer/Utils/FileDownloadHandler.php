...
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\S3\S3Transfer\AbstractMultipartDownloader;
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\S3\S3Transfer\Exception\FileDownloadException;
