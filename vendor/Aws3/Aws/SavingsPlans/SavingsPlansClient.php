 ...
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Promise createSavingsPlanAsync(array $args = [])
 * @method \Aws\Result describeSavingsPlanRates(array $args = [])
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Promise describeSavingsPlanRatesAsync(array $args = [])
 * @method \Aws\Result describeSavingsPlans(array $args = [])
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Promise describeSavingsPlansAsync(array $args = [])
 * @method \Aws\Result describeSavingsPlansOfferingRates(array $args = [])
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Promise describeSavingsPlansOfferingRatesAsync(array $args = [])
 * @method \Aws\Result describeSavingsPlansOfferings(array $args = [])
 * @method \DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Promise describeSavingsPlansOfferingsAsync(array $args = [])
