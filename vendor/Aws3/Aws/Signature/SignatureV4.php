...
use DeliciousBrains\WP_Offload_Media\Aws3\AWS\CRT\Auth\StaticCredentialsProvider;
use DeliciousBrains\WP_Offload_Media\Aws3\AWS\CRT\HTTP\Request;
use DeliciousBrains\WP_Offload_Media\Aws3\Aws\Exception\CommonRuntimeException;
