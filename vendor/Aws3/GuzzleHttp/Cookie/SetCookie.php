...
class SetCookie
{
     ...
     * @var array
     */
    private const DEFAULTS = ['Name' => null, 'Value' => null, 'Domain' => null, 'Path' => '/', 'Max-Age' => null, 'Expires' => null, 'Secure' => \false, 'Discard' => \false, 'HttpOnly' => \false];
    /**
     ...
     */
    public static function fromString(#[\SensitiveParameter] string $cookie) : self
    {
        ...
        foreach ($pieces as $part) {
            ...
            $value = isset($cookieParts[1]) ? \trim($cookieParts[1], " \t") : \true;
     ...
     */
    public function __construct(#[\SensitiveParameter] array $data = [])
    {
     ...
     * @param mixed[] $data
     */
    private static function validateFieldTypes(#[\SensitiveParameter] array $data) : void
    {
