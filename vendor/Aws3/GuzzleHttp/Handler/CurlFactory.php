...
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Exception\ConnectTimeoutException;
...
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Exception\NetworkTimeoutException;
...
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Exception\ResponseTimeoutException;
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Exception\ResponseTransferException;
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Multiplexing;
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\NonSerializableTrait;
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise as P;
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\PromiseInterface;
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\ProxyOptions;
...
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Psr7\HttpFactory;
...
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\TransportSharing;
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Utils;
use DeliciousBrains\WP_Offload_Media\Aws3\Psr\Http\Message\RequestInterface;
use DeliciousBrains\WP_Offload_Media\Aws3\Psr\Http\Message\ResponseInterface;
use DeliciousBrains\WP_Offload_Media\Aws3\Psr\Http\Message\StreamFactoryInterface;
...
final class CurlFactory implements CurlFactoryInterface
{
    ...
    private static function isCurlShareHandle($value) : bool
    {
        ...
        return \class_exists('DeliciousBrains\\WP_Offload_Media\\Aws3\\CurlSharePersistentHandle') && $value instanceof \DeliciousBrains\WP_Offload_Media\Aws3\CurlSharePersistentHandle;
    }
    ...
    private function clearEasyHandleCallbacks($handle) : void
    {
        ...
        if (\defined('DeliciousBrains\\WP_Offload_Media\\Aws3\\CURLOPT_PREREQFUNCTION')) {
    ...
    private function getDefaultConf(#[\SensitiveParameter] EasyHandle $easy) : array
    {
        ...
        if ('3' === $version || '3.0' === $version) {
            if (!\defined('DeliciousBrains\\WP_Offload_Media\\Aws3\\CURL_HTTP_VERSION_3')) {
    ...
    {
        $option = \defined('DeliciousBrains\\WP_Offload_Media\\Aws3\\CURLOPT_INFILESIZE_LARGE') ? (int) \constant('CURLOPT_INFILESIZE_LARGE') : \CURLOPT_INFILESIZE;
