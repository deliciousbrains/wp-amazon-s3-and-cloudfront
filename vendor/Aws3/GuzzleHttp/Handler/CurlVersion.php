...
final class CurlVersion
{
    ...
    public static function supportsCurlHandler() : bool
    {
        ...
        return \defined('CURL_VERSION_SSL') && \defined('CURL_SSLVERSION_TLSv1_2') && \defined('CURLMOPT_MAX_HOST_CONNECTIONS') && \defined('CURLMOPT_MAX_TOTAL_CONNECTIONS') && null !== $versionInfo && \version_compare($versionInfo['version'], self::MIN_VERSION, '>=') && 0 !== (\CURL_VERSION_SSL & $versionInfo['features']);
    }
    public static function supportsTls13() : bool
    {
        $version = self::get();
        return \defined('CURL_SSLVERSION_TLSv1_3') && null !== $version && \version_compare($version, self::TLS_13_VERSION, '>=');
    }
    public static function supportsMultiplex() : bool
    {
        $version = self::get();
        return \defined('CURLOPT_PIPEWAIT') && null !== $version && \version_compare($version, self::MULTIPLEX_VERSION, '>=');
    }
    ...
    {
        $version = self::get();
        return \defined('CURL_HTTP_VERSION_2_PRIOR_KNOWLEDGE') && null !== $version && self::supportsHttp2() && \version_compare($version, self::REQUIRED_HTTP2_MULTIPLEX_VERSION, '>=');
    }
    public static function supportsHttp2() : bool
    {
        ...
        return \defined('CURL_VERSION_HTTP2') && null !== $versionInfo && self::supportsMultiplex() && 0 !== (\CURL_VERSION_HTTP2 & $versionInfo['features']);
    }
    public static function supportsHttp3() : bool
    {
        if (!\defined('CURL_VERSION_HTTP3') || !\defined('DeliciousBrains\\WP_Offload_Media\\Aws3\\CURL_HTTP_VERSION_3') || !\defined('DeliciousBrains\\WP_Offload_Media\\Aws3\\CURL_HTTP_VERSION_3ONLY')) {
            return \false;
        }
        $versionInfo = self::getVersionInfo();
    ...
    {
        $version = self::get();
        return self::supportsHttp3() && null !== $version && \version_compare($version, self::REQUIRED_HTTP3_MULTIPLEX_VERSION, '>=');
    }
    public static function supportsHttpsProxy() : bool
    {
        $versionInfo = self::getVersionInfo();
        return \defined('CURL_VERSION_HTTPS_PROXY') && null !== $versionInfo && \version_compare($versionInfo['version'], self::HTTPS_PROXY_VERSION, '>=') && 0 !== (\CURL_VERSION_HTTPS_PROXY & $versionInfo['features']);
    }
    public static function supportsHandlerSharing() : bool
    {
        $version = self::get();
        return null !== $version && \version_compare($version, self::HANDLER_SHARING_VERSION, '>=');
    }
    ...
    {
        $versionInfo = self::getVersionInfo();
        return \defined('CURL_VERSION_SSL') && null !== $versionInfo && \version_compare($versionInfo['version'], self::SSL_SESSION_SHARING_VERSION, '>=') && 0 !== (\CURL_VERSION_SSL & $versionInfo['features']);
    }
    ...
    {
        $version = self::get();
        return null !== $version && \version_compare($version, self::CONNECTION_SHARING_VERSION, '>=');
    }
    public static function ensureConnectionSharingSupported() : void
    {
        if (!self::supportsConnectionSharing()) {
            throw new InvalidArgumentException(\sprintf('The "transport_sharing" option requires libcurl %s or higher for persistent connection sharing.', self::CONNECTION_SHARING_VERSION));
        }
    }
    public static function supportsShareConnectionCaches() : bool
    {
        ...
        return null === $version || \version_compare($version, self::SHARE_CONNECTION_CACHE_VERSION, '>=');
    }
    public static function supportsProxyTlsCredentialAwareConnectionReuse() : bool
    {
        $version = self::get();
        return null !== $version && \version_compare($version, self::PROXY_TLS_CREDENTIAL_REUSE_VERSION, '>=');
    }
    public static function supportsProxyCredentialAwareConnectionReuse() : bool
    {
        $version = self::get();
        return null !== $version && \version_compare($version, self::PROXY_CREDENTIAL_REUSE_VERSION, '>=');
    }
    public static function supportsSocksProxyCredentialAwareConnectionReuse() : bool
    {
        $version = self::get();
        return null !== $version && \version_compare($version, self::SOCKS_PROXY_CREDENTIAL_REUSE_VERSION, '>=');
    }
    public static function supportsProxyHeaderSeparation() : bool
    {
        $version = self::get();
        return null !== $version && \version_compare($version, self::PROXY_HEADER_SEPARATION_VERSION, '>=') && \defined('CURLOPT_PROXYHEADER') && \defined('CURLOPT_HEADEROPT') && \defined('CURLHEADER_SEPARATE');
    }
    public static function supportsProtocolsStr() : bool
    {
        $version = self::get();
        return \defined('DeliciousBrains\\WP_Offload_Media\\Aws3\\CURLOPT_PROTOCOLS_STR') && null !== $version && \version_compare($version, self::PROTOCOLS_STR_VERSION, '>=');
    }
    public static function supportsProxyTunneling() : bool
    {
        $version = self::get();
        return \defined('CURLOPT_SUPPRESS_CONNECT_HEADERS') && null !== $version && \version_compare($version, self::PROXY_TUNNEL_VERSION, '>=');
    }
    public static function ensureSupported(#[\SensitiveParameter] RequestInterface $request) : void
    {
        ...
        if (null === $version || \version_compare($version, self::MIN_VERSION, '<')) {
            throw new ConnectException(\sprintf('cURL %s or higher is required by the cURL handler; %s is installed.', self::MIN_VERSION, $version ?? 'an unknown version'), $request);
        }
        if (!\defined('CURL_SSLVERSION_TLSv1_2')) {
            throw new ConnectException(\sprintf('The PHP cURL extension must be built against cURL %s or higher to use the cURL handler.', self::MIN_VERSION), $request);
        }
