...
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\ProxySelection;
...
final class ProxyEnv
{
     ...
     */
    public static function resolveProxySelection(UriInterface $uri, #[\SensitiveParameter] $proxyOption) : ProxySelection
    {
