...
class HandlerStack
{
     ...
     */
    public function __invoke(#[\SensitiveParameter] RequestInterface $request, #[\SensitiveParameter] array $options)
    {
    ...
    public function remove($remove) : void
    {
        ...
        if (\is_string($remove)) {
            ...
            $this->stack = \array_values(\array_filter($this->stack, static function (array $tuple) use($remove) : bool {
