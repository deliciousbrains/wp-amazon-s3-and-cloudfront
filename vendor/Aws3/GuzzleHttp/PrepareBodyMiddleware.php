...
use DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Handler\RequestFraming;
...
class PrepareBodyMiddleware
{
     ...
     * Add expect header
     */
    private function addExpectHeader(#[\SensitiveParameter] RequestInterface $request, #[\SensitiveParameter] array $options, array &$modify, ?int $bodySize) : void
    {
