...
class EachPromise implements \DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\PromisorInterface
{
    ...
    {
        $this->iterable = \DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Create::iterFor($iterable);
    ...
    private function createPromise()
    {
        ...
        $this->aggregate = new \DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Promise(function () {
            ...
            while ($promise = current($this->pending)) {
                next($this->pending);
                $promise->wait();
                if (\DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Is::settled($this->aggregate)) {
                    return;
                }
            }
        });
    ...
    private function addPending()
    {
        ...
        $promise = \DeliciousBrains\WP_Offload_Media\Aws3\GuzzleHttp\Promise\Create::promiseFor($this->iterable->current());
