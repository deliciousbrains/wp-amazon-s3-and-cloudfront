...
class AstRuntime
{
    ...
    public function __construct(\DeliciousBrains\WP_Offload_S3\Aws3\JmesPath\Parser $parser = null, callable $fnDispatcher = null)
    {
        $fnDispatcher = $fnDispatcher ?: \DeliciousBrains\WP_Offload_S3\Aws3\JmesPath\FnDispatcher::getInstance();
        $this->interpreter = new \DeliciousBrains\WP_Offload_S3\Aws3\JmesPath\TreeInterpreter($fnDispatcher);
