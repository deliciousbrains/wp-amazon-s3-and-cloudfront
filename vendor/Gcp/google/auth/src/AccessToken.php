...
class AccessToken
{
    ...
    {
        // @codeCoverageIgnoreStart
        if (!class_exists('DeliciousBrains\\WP_Offload_Media\\Gcp\\SimpleJWT\\JWT')) {
    ...
    {
        return call_user_func_array(['DeliciousBrains\\WP_Offload_Media\\Gcp\\SimpleJWT\\JWT', 'decode'], $args);
    }
    /**
