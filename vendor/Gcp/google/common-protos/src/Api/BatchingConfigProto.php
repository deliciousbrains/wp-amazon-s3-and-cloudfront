 ...
 */
class BatchingConfigProto extends \DeliciousBrains\WP_Offload_Media\Gcp\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \DeliciousBrains\WP_Offload_Media\Gcp\Google\Api\BatchingSettingsProto::class);
        $this->thresholds = $var;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \DeliciousBrains\WP_Offload_Media\Gcp\Google\Api\BatchingDescriptorProto::class);
