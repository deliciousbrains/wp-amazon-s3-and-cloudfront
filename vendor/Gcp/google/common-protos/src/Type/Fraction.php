 ...
 */
class Fraction extends \DeliciousBrains\WP_Offload_Media\Gcp\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \DeliciousBrains\WP_Offload_Media\Gcp\GPBMetadata\Google\Type\Fraction::initOnce();
