...
use DeliciousBrains\WP_Offload_Media\Gcp\Google\Protobuf\EnumValueDescriptor;
class EnumDescriptor
{
    ...
    {
        $this->public_desc = new \DeliciousBrains\WP_Offload_Media\Gcp\Google\Protobuf\EnumDescriptor($this);
    }
