...
class Message
{
    ...
    private function convertJsonValueToProtoValue($value, $field, $ignore_unknown, $is_map_key = \false)
    {
        switch ($field->getType()) {
            case GPBType::MESSAGE:
                $klass = $field->getMessageType()->getClass();
                $submsg = new $klass();
                if (\is_a($submsg, "DeliciousBrains\\WP_Offload_Media\\Gcp\\Google\\Protobuf\\Duration")) {
                    if (\is_null($value)) {
                        return $this->defaultValue($field);
                    } else {
                        if (!\is_string($value)) {
                    ...
                    if ($field->isTimestamp()) {
                        ...
                        if (\is_a($submsg, "DeliciousBrains\\WP_Offload_Media\\Gcp\\Google\\Protobuf\\FieldMask")) {
                            if (\is_null($value)) {
                                return $this->defaultValue($field);
                            }
                            try {
                            ...
                            if (\is_null($value) && !\is_a($submsg, "DeliciousBrains\\WP_Offload_Media\\Gcp\\Google\\Protobuf\\Value")) {
                                return $this->defaultValue($field);
                            }
    ...
    protected function mergeFromJsonArray($array, $ignore_unknown)
    {
        ...
        if (\is_a($this, "DeliciousBrains\\WP_Offload_Media\\Gcp\\Google\\Protobuf\\BytesValue")) {
            $this->setValue(\base64_decode($array));
            return;
        }
        if (\is_a($this, "DeliciousBrains\\WP_Offload_Media\\Gcp\\Google\\Protobuf\\Duration")) {
        ...
        if (\is_a($this, "DeliciousBrains\\WP_Offload_Media\\Gcp\\Google\\Protobuf\\Timestamp")) {
            $this->mergeFrom(GPBUtil::parseTimestamp($array));
            return;
        }
        if (\is_a($this, "DeliciousBrains\\WP_Offload_Media\\Gcp\\Google\\Protobuf\\Struct")) {
    ...
    public function parseFromJsonStream($input, $ignore_unknown)
    {
        ...
        if ($this instanceof \DeliciousBrains\WP_Offload_Media\Gcp\Google\Protobuf\ListValue) {
            $array = ["values" => $array];
        }
        if (\is_null($array)) {
            if ($this instanceof \DeliciousBrains\WP_Offload_Media\Gcp\Google\Protobuf\Value) {
                $this->setNullValue(\DeliciousBrains\WP_Offload_Media\Gcp\Google\Protobuf\NullValue::NULL_VALUE);
                return;
            } else {
    ...
    public function serializeToJsonStream(&$output)
    {
        if (\is_a($this, 'DeliciousBrains\\WP_Offload_Media\\Gcp\\Google\\Protobuf\\Any')) {
            ...
            $output->writeRaw("}", 1);
        } elseif (\is_a($this, 'DeliciousBrains\\WP_Offload_Media\\Gcp\\Google\\Protobuf\\FieldMask')) {
            $field_mask = GPBUtil::formatFieldMask($this);
            $output->writeRaw("\"", 1);
            $output->writeRaw($field_mask, \strlen($field_mask));
            $output->writeRaw("\"", 1);
        } elseif (\is_a($this, 'DeliciousBrains\\WP_Offload_Media\\Gcp\\Google\\Protobuf\\Duration')) {
            $duration = GPBUtil::formatDuration($this) . "s";
            $output->writeRaw("\"", 1);
            $output->writeRaw($duration, \strlen($duration));
            $output->writeRaw("\"", 1);
        } elseif (\get_class($this) === 'DeliciousBrains\\WP_Offload_Media\\Gcp\\Google\\Protobuf\\Timestamp') {
    ...
    private function fieldDataOnlyJsonByteSize($field, $value)
    {
        ...
        switch ($field->getType()) {
            ...
            case GPBType::ENUM:
                ...
                if ($enum_desc->getClass() === "DeliciousBrains\\WP_Offload_Media\\Gcp\\Google\\Protobuf\\NullValue") {
                    $size += 4;
                    break;
                }
    ...
    public function jsonByteSize()
    {
        ...
        } elseif (\get_class($this) === 'DeliciousBrains\\WP_Offload_Media\\Gcp\\Google\\Protobuf\\FieldMask') {
            $field_mask = GPBUtil::formatFieldMask($this);
            $size += \strlen($field_mask) + 2;
            // 2 for ""
        } elseif (\get_class($this) === 'DeliciousBrains\\WP_Offload_Media\\Gcp\\Google\\Protobuf\\Duration') {
            $duration = GPBUtil::formatDuration($this) . "s";
