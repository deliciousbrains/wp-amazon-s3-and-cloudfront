 ...
 */
class Value extends \DeliciousBrains\WP_Offload_Media\Gcp\Google\Protobuf\Internal\Message
{
    protected $kind;
    /**
     * Constructor.
    ...
    {
        GPBUtil::checkEnum($var, \DeliciousBrains\WP_Offload_Media\Gcp\Google\Protobuf\NullValue::class);
    ...
    {
        GPBUtil::checkMessage($var, \DeliciousBrains\WP_Offload_Media\Gcp\Google\Protobuf\ListValue::class);
