...
use DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Handler\CurlShareHandleState;
...
use DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Psr7\DiagnosticValue;
 ...
 * @final
 */
class Client implements ClientInterface, \DeliciousBrains\WP_Offload_Media\Gcp\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
