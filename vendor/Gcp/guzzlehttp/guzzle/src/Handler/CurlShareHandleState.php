...
final class CurlShareHandleState
{
    ...
    {
        return CurlVersion::supportsConnectionSharing() && CurlVersion::supportsSslSessionSharing() && \function_exists('DeliciousBrains\\WP_Offload_Media\\Gcp\\curl_share_init_persistent') && \class_exists('DeliciousBrains\\WP_Offload_Media\\Gcp\\CurlSharePersistentHandle') && \defined('CURL_LOCK_DATA_DNS') && \defined('CURL_LOCK_DATA_CONNECT') && \defined('CURL_LOCK_DATA_SSL_SESSION');
    }
    /**
     * @return int[]
     */
