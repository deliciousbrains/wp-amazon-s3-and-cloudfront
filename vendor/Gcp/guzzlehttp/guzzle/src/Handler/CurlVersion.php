...
final class CurlVersion
{
    ...
    {
        if (!\defined('CURL_VERSION_HTTP3') || !\defined('DeliciousBrains\\WP_Offload_Media\\Gcp\\CURL_HTTP_VERSION_3') || !\defined('DeliciousBrains\\WP_Offload_Media\\Gcp\\CURL_HTTP_VERSION_3ONLY')) {
            return \false;
        }
        $versionInfo = self::getVersionInfo();
    ...
    {
        $version = self::get();
        return \defined('DeliciousBrains\\WP_Offload_Media\\Gcp\\CURLOPT_PROTOCOLS_STR') && null !== $version && \version_compare($version, self::PROTOCOLS_STR_VERSION, '>=');
    }
