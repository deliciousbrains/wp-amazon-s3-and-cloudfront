...
final class EasyHandle
{
    ...
    public function createResponse() : void
    {
        ...
        $headers = \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Utils::headersFromLines($this->headers);
        ...
        $this->response = new \DeliciousBrains\WP_Offload_Media\Gcp\GuzzleHttp\Psr7\Response($statusCode, $headers, $this->sink, \substr($startLine[0], 5), isset($startLine[2]) ? (string) $startLine[2] : null);
    }
    /**
     * @param string $name
     *
