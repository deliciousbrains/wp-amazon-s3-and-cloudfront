...
class RotatingFileHandler extends \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Logger::DEBUG, bool $bubble = true, ?int $filePermission = null, bool $useLocking = false)
    {
        $this->filename = \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Utils::canonicalizePath($filename);
