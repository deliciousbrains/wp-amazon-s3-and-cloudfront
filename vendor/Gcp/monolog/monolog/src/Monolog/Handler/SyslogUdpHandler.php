...
class SyslogUdpHandler extends \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Handler\AbstractSyslogHandler
{
     ...
     */
    public function __construct(string $host, int $port = 514, $facility = LOG_USER, $level = \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Logger::DEBUG, bool $bubble = true, string $ident = 'php', int $rfc = self::RFC5424)
    {
     ...
     */
    public function setSocket(\DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Handler\SyslogUdp\UdpSocket $socket) : self
    {
        $this->socket = $socket;
        return $this;
    }
