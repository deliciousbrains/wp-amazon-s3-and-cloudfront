 ...
 */
class TelegramBotHandler extends \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Handler\AbstractProcessingHandler
{
     ...
     * @inheritDoc
     */
    public function __construct(string $apiKey, string $channel, $level = \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Logger::DEBUG, bool $bubble = true, string $parseMode = null, bool $disableWebPagePreview = null, bool $disableNotification = null)
    {
    ...
    protected function send(string $message) : void
    {
        ...
        $result = \DeliciousBrains\WP_Offload_Media\Gcp\Monolog\Handler\Curl\Util::execute($ch);
