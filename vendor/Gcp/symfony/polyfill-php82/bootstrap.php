 ...
 */
use DeliciousBrains\WP_Offload_Media\Gcp\Symfony\Polyfill\Php82 as p;
...
if (\extension_loaded('odbc')) {
    if (!\function_exists('DeliciousBrains\\WP_Offload_Media\\Gcp\\odbc_connection_string_is_quoted')) {
        function odbc_connection_string_is_quoted(string $str) : bool
        {
            return p\Php82::odbc_connection_string_is_quoted($str);
        }
    }
    if (!\function_exists('DeliciousBrains\\WP_Offload_Media\\Gcp\\odbc_connection_string_should_quote')) {
        function odbc_connection_string_should_quote(string $str) : bool
        {
            return p\Php82::odbc_connection_string_should_quote($str);
        }
    }
    if (!\function_exists('DeliciousBrains\\WP_Offload_Media\\Gcp\\odbc_connection_string_quote')) {
